...
//on insère l'objet dans la BDD via le ContentValues
    ...
    private Echantillon cursorToEchant(Cursor c){ //Cette méthode permet de convertir un cursor en un echantillon
...
//Récupère dans un Cursor les valeurs correspondant à un echantillon grâce à sa designation)
    ...
    public boolean IsEchantillionNotExist(String uncode){
        boolean result = true;
//Récupère dans un Cursor les valeurs correspondant à un echantillon grâce à sa designation)
    ...
    public boolean IsEchantillionExist(String uncode){
